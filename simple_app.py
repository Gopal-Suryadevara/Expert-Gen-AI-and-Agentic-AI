...
# Text Input
user_name = st.sidebar.text_input("What is your name?", "Gopal Suryadevara")

# Slider
age = st.sidebar.slider("Select your age", 0, 100, 25) #min=0, max=100, default = 25

# Selectbox
favorite_color = st.sidebar.selectbox("What is your favorite color?", ["Black", "Brown", "White", "Blue", "Red", "Green", "Yellow"])
